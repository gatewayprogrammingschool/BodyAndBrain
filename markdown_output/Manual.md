...
* [Body And Brain - A Simple Role-Playing System](#body-and-brain---a-simple-role-playing-system)
  ...
  * [Character Creation](#character-creation)
    ...
    * [Starting Skill Packages](#starting-skill-packages)
    * [Character Sheet Calculations](#character-sheet-calculations)
    * [Resistance Rolls](#resistance-rolls)
    * [Character Stats](#character-stats)
  * [Races](#races)
    * [Level And Life Stage](#level-and-life-stage)
    * [Age Influence On Stats](#age-influence-on-stats)
    * [Elf](#elf)
    * [Human](#human)
    * [Half-Elf](#half-elf)
    * [Dwarf](#dwarf)
  ...
  * [Adventuring](#adventuring)
    * [General Maneuvers](#general-maneuvers)
  * [Magic](#magic)
    * [Spell Lists](#spell-lists)
    * [Casting Procedure](#casting-procedure)
    * [Spell And Creature Terms](#spell-and-creature-terms)
    * [Blessings](#blessings)
    * [Body](#body)
    * [Curses](#curses)
    * [Destroy](#destroy)
  ...
  * [Non-Player Characters](#non-player-characters)
    ...
    * [NPC Level Significance](#npc-level-significance)
    * [NPC Stat Factors](#npc-stat-factors)
    * [NPC Skill Factors](#npc-skill-factors)
    * [NPC Stat Arrays](#npc-stat-arrays)
    * [NPC Hits](#npc-hits)
  ...
  * [Apprenticeships](#apprenticeships)
    ...
    * [Rogue Apprenticeships](#rogue-apprenticeships)
...
Elves are very intelligent, perceptive and wise.  They have a great presence about them and the more gregarious of them tend to be [Bards](#Bard), with many specializing in [acting](#actor) while others with a more adventurous side going into [fencing](#Fencing) or [politics](#politician).

Elves are slight of frame, but are not impeded in the arena of [Strength](#Strength), and are especially agile.  Their combination of [Agility](#Agility), [Presence](#Presence) and [Intelligence](#Intelligence) makes them excellent [Rangers](#Ranger) and [Rogues](#Rogue).  [Piety](#Piety) is the Elf's Achilles Heel since they consider themselves akin to the Gods and are not very modest about it, which means that Elves cannot be [Paladins](#Paladin) or [Clerics](#Cleric).
...
[__Available Apprenticeships__](#fighter-apprenticeships)
...
[__Available Apprenticeships__](#berserker-apprenticeships)
...
[__Available Apprenticeships__](#paladin-apprenticeships)
...
[__Available Apprenticeships__](#ranger-apprenticeships)
...
[__Available Apprenticeships__](#rogue-apprenticeships)
...
[__Available Apprenticeships__](#wizard-apprenticeships)
...
[__Available Apprenticeships__](#conjuror-apprenticeships)
...
[__Available Apprenticeships__](#cleric-apprenticeships)
...
At the start of a fight, each participant rolls `D100 + Agility bonus + Perception bonus` for initiative. Highest result acts first. Ties act at the same time unless the GM needs an order, in which case the higher Agility bonus breaks the tie.
...
Attacks are resolved with `D100 + attack bonus` against the appropriate outcome table. A hit deals the listed damage, modified by the outcome. `Hit / 2` halves damage after rolling. `Hit + Critical` deals normal damage and then resolves the critical type. A natural 1 is always a fumble, and a natural 100 is always the best listed result for that attack type.
...
#### Critical And Failure Resolution
...
#### Calculating Physical Attack Bonus
...
#### Base Spell And Element Attack Bonuses
...
#### Spell Critical And Failure Resolution
...
Short Swords use the 1H Edge attack profile. Compared with a Broadsword, a Short Sword keeps the same base `1D6` damage but has a narrower critical range (`6` instead of `5,6`).

#### Broadsword

Broadswords are the baseline one-handed edged sword. They use the 1H Edge attack profile, deal `1D6` base damage, and critically hit on `5,6`.
